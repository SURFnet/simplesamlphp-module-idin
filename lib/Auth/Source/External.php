 ...
 * 3. Copy this file and modules/idin/www/resume.php to their corresponding
 *    location in the new module.
 * 4. Replace all occurrences of "idin" in this file and in resume.php with the name of your module.
 ...
 */
class sspmod_idin_Auth_Source_External extends SimpleSAML_Auth_Source {
	...
	public function authenticate(&$state) {
		 ...
		 */
		$stateId = SimpleSAML_Auth_State::saveState($state, 'idin:External');
		 ...
		 */
		$returnTo = SimpleSAML_Module::getModuleURL('idin/resume.php', array(
			'State' => $stateId,
		));
		 ...
		 */
		$authPage = SimpleSAML_Module::getModuleURL('idin/authpage.php');
	...
	public static function resume() {
		 ...
		 */
		$state = SimpleSAML_Auth_State::loadState($_REQUEST['State'], 'idin:External');

		/*
		 * Now we have the $state-array, and can use it to locate the authentication
		 * source.
		 */
		$source = SimpleSAML_Auth_Source::getById($state['idin:AuthID']);
		if ($source === NULL) {
			/*
